...
public class Wizard extends Application{
	...
	private void criarPasso1() {
		...
		Button proximoSair = new Button("Sair");
		proximoSair.setOnAction(e -> {
			System.exit(1);
		});
		...
		box.getChildren().add(proximoSair);
		
		passo1 = new Scene(box, 400, 400);
	}
	
	private void criarPasso2() {
		Button passoAnterior = new Button("Volta para passo 1");
	...
	private void criarPasso3() {
		Button passoAnterior = new Button("Volta para passo 2");
		passoAnterior.setOnAction(e -> {
			janela.setScene(passo2);
			janela.setTitle("Wizard - Passo 2");
		});
		
		Button proximoPasso = new Button("Ir para passo 1");
		proximoPasso.setOnAction(e -> {
			janela.setScene(passo1);
			janela.setTitle("Wizard - Passo 1");
		});
